        ...
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                ...
                <View style={styles.headerTextContainer}>
                    ...
                    <Text style={styles.subtitle}>Micro-climate hyper-local data</Text>
                </View>
            </View>
            ...
            <View style={styles.content}>
                <BlurView intensity={40} tint="light" style={styles.premiumPlaceholder}>
                    <LinearGradient
                        colors={['rgba(245, 158, 11, 0.1)', 'rgba(59, 130, 246, 0.1)']}
                        style={styles.placeholderIcon}
                    >
                        <MaterialCommunityIcons name="weather-partly-cloudy" size={64} color="#f59e0b" />
                    </LinearGradient>
                    <Text style={styles.placeholderTitle}>Weather Insights Soon</Text>
                    <Text style={styles.placeholderText}>
                        We are integrating hyper-local satellite weather data to give you farm-specific rainfall predictions.
                    </Text>
...
const styles = StyleSheet.create({
    ...
    premiumPlaceholder: { padding: 32, borderRadius: 32, alignItems: 'center', backgroundColor: 'rgba(255,255,255,0.5)', borderWidth: 1, borderColor: 'rgba(0,0,0,0.05)', width: '100%' },
