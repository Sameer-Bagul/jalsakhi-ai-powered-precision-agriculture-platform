...
const styles = StyleSheet.create({
    ...
    bentoGrid: { gap: 16 },
    fullWidth: { width: '100%' },
    glassCard: { borderRadius: 24, overflow: 'hidden', backgroundColor: 'white', borderWidth: 1, borderColor: 'rgba(255,255,255,0.7)', elevation: 1, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.03, shadowRadius: 10 },
    ...
    mainRecGradient: { borderRadius: 28, padding: 24, elevation: 8, shadowColor: '#10b981', shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.2, shadowRadius: 15 },
    ...
    logBtn: { marginTop: 24, borderRadius: 20, overflow: 'hidden', elevation: 8, shadowColor: '#3b82f6', shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.2, shadowRadius: 12 },
